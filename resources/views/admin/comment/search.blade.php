                                ...
                                <td>
                                    <label class="switch switch-3d switch-success mr-3" id="active{{$comment->id}}">
                                        @if($comment->status == config('setting.status_1'))
                                            <a onclick="return ajaxToggleActiveComment({{$comment->id}}, {{ config('setting.status_1') }})"><img src="/assets/images/active.gif" />@lang('comment.status-accept')</a>
                                        @else
                                            <a onclick="return ajaxToggleActiveComment({{$comment->id}}, {{ config('setting.status_0') }})"><img src="/assets/images/deactive.gif" />@lang('comment.status-reject')</a>
                                        @endif
