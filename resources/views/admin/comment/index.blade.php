                                ...
                                <td>
                                    <label class="switch switch-3d switch-success mr-3" id="active{{$comment->id}}">
                                        @if($comment->status == config('setting.status_1'))
                                            <a onclick="return ajaxToggleActiveComment({{$comment->id}}, 1)"><img src="/assets/images/active.gif" />Accept display</a>
                                        @else
                                            <a onclick="return ajaxToggleActiveComment({{$comment->id}}, 0)"><img src="/assets/images/deactive.gif" />Reject display</a>
                                        @endif
