                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @foreach($publishers as $publisher)
                            ...
                            <tr class="gradeX">
                                ...
                                <td>{!! $description !!}</td>
                                <td class="center">
                                    <button type="button" class="btn btn-primary" data-id_publisher="{!! $id !!}" data-name="{!! $name !!}" data-description="{!! $description !!}" data-toggle="modal" data-target="#myModalPublisher">
